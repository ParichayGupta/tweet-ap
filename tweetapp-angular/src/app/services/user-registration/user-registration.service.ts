...
export const API_URL="http://tweetapp-lb-1878492337.us-east-1.elb.amazonaws.com/api/v1.0/tweets/register";
export const Users_URL ="http://tweetapp-lb-1878492337.us-east-1.elb.amazonaws.com/api/v1.0/tweets/users/all";
export const Search_URL = "http://tweetapp-lb-1878492337.us-east-1.elb.amazonaws.com/api/v1.0/tweets/user/search/";
export const Forgot_URL="http://tweetapp-lb-1878492337.us-east-1.elb.amazonaws.com/api/v1.0/tweets";
@Injectable({
  providedIn: 'root'
})
